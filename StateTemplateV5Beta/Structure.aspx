<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Structure.aspx.cs" Inherits="StateTemplateV5Beta.Structure" %>
    ...
    <h1>State Template Structure</h1>
                            ...
                            <div class="group">
                                <div class="half">
                                    ...
                                    <p>There are several new structural elements in the v5 of the state template. Most are optional and one is required namely the <code>utility-header.html</code> located in the <code>ssi</code> folder of the template.</p>
                                    <ul class="list-standout">
                                        ...
                                        <li>
                                            ...
                                            This is a banner that serves as a tool to communicate important or timely information to your users. More information can be found on the <a href="/sample/alert-banner.html">Alert Banner page</a>.
                                        </li>
                                    </ul>
                                    <h2>Server Side Includes</h2>
                                    <p>Several common components (such as page headers, footers, navigation, etc.) are included in pages using Server Side Includes (SSI). Note that the web server that hosts the State Template should be configured to process SSI's with the .html extension.</p>
                                    <h2>Icon Fonts</h2>
                                    <p><a href="/sample/icon-fonts.html">Icon Fonts</a> are also included as part of the State Template. These icon fonts were developed by OTECH, with some additions from other sources.</p>
