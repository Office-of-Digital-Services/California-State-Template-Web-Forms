<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="StateTemplateV5._Default" %>

    <asp:Content ID="BannerContent" ContentPlaceHolderID="BannerContent" runat="server">
        <section aria-label="hero banner">
            <div class="banner-main" role="banner">
                <div class="container">
                    <h1><span class="home-logo rounded-50x"><i class="ca-gov-icon-capitol"
                                aria-hidden="true"></i></span>&nbsp;Web Forms State Template Project</h1>
                </div>
            </div>
        </section>
    </asp:Content>
                        ...
                        <div id="email-box" class="form-group m-b-md">
                            <div class="input-group">
                                <div class="input-group-addon d-flex">
                                    <i class="ca-gov-icon-person" aria-hidden="true"></i>
                                </div>
                            ...
                            <div class="input-group m-t-md">
                                <div class="input-group-addon d-flex">
                                    <i class="ca-gov-icon-key" aria-hidden="true"></i>
                                </div>
                            ...
                            <small id="email-feedback" class="feedback" style="display:none">Email not registered,
                                please
                                register to continue.</small>
                        </div>
                        <div class="row">
                            <div class="half">
                                <label class="form-check-inline p-l-md m-l-0 m-r-md" for="remebmer">
                                    ...
                                    <div class="check-icon-checkbox">
                                        <i class="ca-gov-icon-check-mark" aria-hidden="true"></i>
                                    </div>
